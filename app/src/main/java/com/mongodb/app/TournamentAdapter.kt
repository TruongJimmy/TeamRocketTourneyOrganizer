...
internal class TournamentAdapter(data: OrderedRealmCollection<Tournament>, private val config: RealmConfiguration, private val mContext: Context) : RealmRecyclerViewAdapter<Tournament, TournamentAdapter.TournamentViewHolder?>(data, true) {
