...
public final class ActivityRowRankingBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityRowRankingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRowRankingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_row_ranking, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRowRankingBinding bind(@NonNull View rootView) {
