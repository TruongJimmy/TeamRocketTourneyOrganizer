...
public final class FragmentBracketBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentBracketBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentBracketBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_bracket, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBracketBinding bind(@NonNull View rootView) {
