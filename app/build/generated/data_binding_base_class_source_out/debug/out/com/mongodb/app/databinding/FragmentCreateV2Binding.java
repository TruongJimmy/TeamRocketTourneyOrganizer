...
public final class FragmentCreateV2Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentCreateV2Binding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentCreateV2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCreateV2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_create_v2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCreateV2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCreateV2Binding((FrameLayout) rootView, createTournamentButtonButton,
