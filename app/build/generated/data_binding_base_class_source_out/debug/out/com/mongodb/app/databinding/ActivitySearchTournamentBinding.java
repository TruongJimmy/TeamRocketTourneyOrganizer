...
public final class ActivitySearchTournamentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivitySearchTournamentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySearchTournamentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_search_tournament, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySearchTournamentBinding bind(@NonNull View rootView) {
