...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    static {
        ...
        modelClasses.add(com.mongodb.app.LewisTest.class);
    ...
    public Map<Class<? extends RealmModel>, OsObjectSchemaInfo> getExpectedObjectSchemaInfoMap() {
        ...
        infoMap.put(com.mongodb.app.LewisTest.class, io.realm.com_mongodb_app_LewisTestRealmProxy.getExpectedObjectSchemaInfo());
    ...
    public ColumnInfo createColumnInfo(Class<? extends RealmModel> clazz, OsSchemaInfo schemaInfo) {
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            return io.realm.com_mongodb_app_LewisTestRealmProxy.createColumnInfo(schemaInfo);
        }
    ...
    public <E extends RealmModel> E newInstance(Class<E> clazz, Object baseRealm, Row row, ColumnInfo columnInfo, boolean acceptDefaultValue, List<String> excludeFields) {
        ...
        try {
            ...
            if (clazz.equals(com.mongodb.app.LewisTest.class)) {
                return clazz.cast(new io.realm.com_mongodb_app_LewisTestRealmProxy());
            }
            if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E obj, boolean update, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            com_mongodb_app_LewisTestRealmProxy.LewisTestColumnInfo columnInfo = (com_mongodb_app_LewisTestRealmProxy.LewisTestColumnInfo) realm.getSchema().getColumnInfo(com.mongodb.app.LewisTest.class);
            return clazz.cast(io.realm.com_mongodb_app_LewisTestRealmProxy.copyOrUpdate(realm, columnInfo, (com.mongodb.app.LewisTest) obj, update, cache, flags));
        }
        if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public void insert(Realm realm, RealmModel object, Map<RealmModel, Long> cache) {
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            io.realm.com_mongodb_app_LewisTestRealmProxy.insert(realm, (com.mongodb.app.LewisTest) object, cache);
    ...
    public void insert(Realm realm, Collection<? extends RealmModel> objects) {
        ...
        if (iterator.hasNext()) {
            ...
            if (iterator.hasNext()) {
                if (clazz.equals(com.mongodb.app.LewisTest.class)) {
                    io.realm.com_mongodb_app_LewisTestRealmProxy.insert(realm, iterator, cache);
                } else if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public void insertOrUpdate(Realm realm, RealmModel obj, Map<RealmModel, Long> cache) {
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            io.realm.com_mongodb_app_LewisTestRealmProxy.insertOrUpdate(realm, (com.mongodb.app.LewisTest) obj, cache);
        } else if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public void insertOrUpdate(Realm realm, Collection<? extends RealmModel> objects) {
        ...
        if (iterator.hasNext()) {
            ...
            if (clazz.equals(com.mongodb.app.LewisTest.class)) {
                io.realm.com_mongodb_app_LewisTestRealmProxy.insertOrUpdate(realm, (com.mongodb.app.LewisTest) object, cache);
            } else if (clazz.equals(com.mongodb.app.Games.class)) {
            ...
            if (iterator.hasNext()) {
                if (clazz.equals(com.mongodb.app.LewisTest.class)) {
                    io.realm.com_mongodb_app_LewisTestRealmProxy.insertOrUpdate(realm, iterator, cache);
                } else if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public <E extends RealmModel> E createOrUpdateUsingJsonObject(Class<E> clazz, Realm realm, JSONObject json, boolean update)
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            return clazz.cast(io.realm.com_mongodb_app_LewisTestRealmProxy.createOrUpdateUsingJsonObject(realm, json, update));
        }
        if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public <E extends RealmModel> E createUsingJsonStream(Class<E> clazz, Realm realm, JsonReader reader)
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            return clazz.cast(io.realm.com_mongodb_app_LewisTestRealmProxy.createUsingJsonStream(realm, reader));
        }
        if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public <E extends RealmModel> E createDetachedCopy(E realmObject, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            return clazz.cast(io.realm.com_mongodb_app_LewisTestRealmProxy.createDetachedCopy((com.mongodb.app.LewisTest) realmObject, 0, maxDepth, cache));
        }
        if (clazz.equals(com.mongodb.app.Games.class)) {
    ...
    public <E extends RealmModel> void updateEmbeddedObject(Realm realm, E unmanagedObject, E managedObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (clazz.equals(com.mongodb.app.LewisTest.class)) {
            throw getNotEmbeddedClassException("com.mongodb.app.LewisTest");
        } else if (clazz.equals(com.mongodb.app.Games.class)) {
